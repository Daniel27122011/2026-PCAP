...
'''
# Objetivo: Ler nome,salário fixo a total de vendas; calcular e exibir o total a receber

# --- ANÁLISE (LIAC)---
# Entrada: nome (texto), salário fixo (float), total de vendas efetuadas (float)
# Processamento: comisão = vendas * 0.15 total = salário fixo + comissão
# Sáida: exibir no formato exato "TOTAL = R$ valor" com 2 casas decimais

# input() sem converção retorna o nome como texto (str)
n = input()
...
# O vendedor ganha 15% de comissão sobre total de vendas
c = v * 0.15 
