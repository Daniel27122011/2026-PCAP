...
Jogo de adivinhação feito em Python na discilpina PCAP (Aula 16).O computador sorteia um número e você tenta descobrir dentro de um limite de chances. Tem 3 níveis: Fácil, Médio e Impossível.
